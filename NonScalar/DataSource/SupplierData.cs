...
namespace SupplierData {
  ...
  /// </summary>
  public class RelS : RelValueST<TupS> { }
  /// <summary>
  ...
  /// </summary>
  public class RelP : RelValueST<TupP> { }
  ...
  /// </summary>
  public class RelSP : RelValueST<TupSP> { }
  ...
  /// </summary>
  public class RelJ : RelValueST<TupJ> { }
  /// <summary>
  ...
  /// </summary>
  public class RelSPJ : RelValueST<TupSPJ> { }
